...
class PromptGeneratorApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Prompt Generator v23.2")
        self.root.geometry("1500x1000")
        self.root.minsize(1260, 880)

        self.base_dir = Path(__file__).resolve().parent
        self.config_path = self.base_dir / "prompt_config_v23_2.json"
    ...
    def _build_ui(self):
        ...
        self.cinema_box = ttk.Combobox(
            top,
            textvariable=self.cinema_mode,
            values=self.cfg("cinematic_presets_order"),
            width=18,
            state="readonly",
        )
    ...
    def update_cinema_state(self, *args):
        ...
        try:
            ...
            pass
        self.cinema_hint.configure(text="僅在光線 = cinematic 時生效" if not enabled else "目前已啟用")
